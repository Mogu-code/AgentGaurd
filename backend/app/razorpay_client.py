...
def get_razorpay_mode() -> str:
    mode = os.getenv("RAZORPAY_MODE", "mock").lower()
    key_id = os.getenv("RAZORPAY_KEY_ID")
    key_secret = os.getenv("RAZORPAY_KEY_SECRET")
    if mode == "test" and key_id and key_secret:
        return "test"
    return "mock"


def get_razorpay_client():
    if get_razorpay_mode() == "test":
        return RealRazorpayClient(os.getenv("RAZORPAY_KEY_ID"), os.getenv("RAZORPAY_KEY_SECRET"))
